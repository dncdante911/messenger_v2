...
## 7. Разделение ответственности (Routing & Performance Strategy)
Текущая стратегия разработки проекта — постепенная и целенаправленная миграция всех критичных к скорости узлов на Node.js, оставляя «холодный» функционал на PHP.
