...
ALTER TABLE `Wo_Channel_Bans`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `channel_user_unique` (`channel_id`,`user_id`),
...
ALTER TABLE `Wo_Messages`
  ...
  ADD KEY `idx_text_preview` (`text_preview`(50));
...
ALTER TABLE `Wo_Users`
  MODIFY `user_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=686;
